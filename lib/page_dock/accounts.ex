defmodule PageDock.Accounts do
  @moduledoc """
  ...
  alias PageDock.Accounts.{User, UserToken, UserNotifier}
  ...
  See `PageDock.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PageDock.Accounts.User.password_changeset/3` for a list of supported options.
